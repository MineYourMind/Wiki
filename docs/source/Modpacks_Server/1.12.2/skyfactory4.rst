...
Warning:
 ...
 Due to how Cachet works with Prestige Points you will not be able to change how the points are allocated. If you use the respec button you will loose both the advancement and the points if those points were earned using the Cachet system.
